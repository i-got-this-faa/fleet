...
At the end of the run, before handing back, check the log told the truth. Read this run's transcript under the active workspace's transcript directory when the host provides one. Do not search unrelated projects. Walk the log against what actually happened:
